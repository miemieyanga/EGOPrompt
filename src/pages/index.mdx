...
links:
  ...
  - name: Code
    url: https://github.com/miemieyanga/EGO-Prompt
    icon: ri:github-line
  - name: arXiv
    url: https://github.com/
...
<Figure>
  <Picture slot="figure" src={main} alt="Overview of the proposed EGO-Prompt framework." />
